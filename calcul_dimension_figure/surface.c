...
ouble surface_rectangle(double longueur, double largeur) {
...
double surface_cercle(double rayon) {
    return M_PI * rayon * rayon; // La surface d'un cercle est pi * rayon^2
}
...
Écrire une fonction qui permet de calculer le périmètre d'un cercle
urface d'un rectangle")
        print("4. Calculer le péri#include <stdio.h>
#include <math.h>  // Pour utiliser la constante M_PI
...
Écrire une fonction qui permet de calculer la surface d'une sphère
#include <stdio.h>
#include <math.h>  // Pour utiliser la constante M_PI

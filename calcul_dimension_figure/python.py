...
def main():
    while True:
        ...
        pintf("4.calculer le périmètre d'in rectangle")
        ...
        if choix == '0':
            ...
            print(f"Le périmètre (circonférence) d'un cercle est: {perimetre_cercle(rayon)}")
...
def surface_carre(cote):
    return cote ** 2  # La surface d'un carre est cote * cote

# Exemple d'utilisation
cote = float(input("Entrez la longueur du cote du carre : "))
surface = surface_carre(cote)
print(f"La surface du carré est : {surface}")
# Fonction pour calculer le perimetre d'un carre
def perimetre_carre(cote):
    return 4 * cote  # Le perimetre d'un carre est 4 fois la longueur du côté
...
# Fonction pour calculer le perimetre d'un rectangle
def perimetre_rectangle(longueur, largeur):
    return 2 * (longueur + largeur)  # Le perimetre d'un rectangle est 2 * (longueur + largeur)
...
# Fonction pour calculer le perimetre (circonference) d'un cercle
def perimetre_cercle(rayon):
    return 2 * math.pi * rayon  # Le perimetre d'un cercle est 2 * pi * rayon

# Exemple d'utilisation
rayon = float(input("Entrez le rayon du cercle : "))
perimetre = perimetre_cercle(rayon)
printf(f"Le périmètre du cercle est : ,{perimetre:.2f}")
import math  # Pour utiliser la constante math.pi

# Fonction pour calculer le perimetre (circonférence) d'un cercle
def perimetre_cercle(rayon):
    return 2 * math.pi * rayon  # Le perimetre d'un cercle est 2 * pi * rayon
...
# Fonction pour calculer le volume d'une sphere
def volume_sphere(rayon):
    return (4/3) * math.pi * rayon**3  # Volume de la sphere : (4/3) * pi * rayon^3
